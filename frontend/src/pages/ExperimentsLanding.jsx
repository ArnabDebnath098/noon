...
const ICONS = {
  ...
  cart: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M2.1 2.6a.9.9 0 01.9-.9h1.3c.86 0 1.6.6 1.78 1.45l.13.6h9.9c.98 0 1.7.92 1.46 1.87l-1.2 4.65a1.8 1.8 0 01-1.74 1.35H7.3a1.8 1.8 0 01-1.76-1.42L3.87 3.9a.1.1 0 00-.1-.08H3a.9.9 0 01-.9-.9zM7.4 14.6a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm7 0a1.5 1.5 0 100 3 1.5 1.5 0 000-3z"
    />
  ),
}
