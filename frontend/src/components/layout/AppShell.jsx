  ...
  return (
    <div
      ...
      style={{
        ...
        // clear the home-bar indicator (--sab). In a plain browser tab both stay
        // 0 — the tab's own chrome already owns those regions (and iOS reports a
        // spurious bottom inset there, so --sab must not trust env() in a tab).
