...
export default function HomeSkeleton() {
  return (
    <div data-id="mp-home-skeleton" className="flex animate-pulse flex-col gap-5 bg-white pt-3">
      {/* promo banner */}
      <div data-id="mp-skeleton-promo" className="px-4">
        <div className={`h-40 w-full rounded-[20px] ${BLOCK}`} />
      </div>

      {/* offer strip */}
      <div data-id="mp-skeleton-strip" className="px-4">
      ...
      {/* combos */}
      <div data-id="mp-skeleton-combos" className="flex flex-col gap-3 px-4 pb-4">
