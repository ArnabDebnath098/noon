...
export default function BundleSheet({ open, onClose, items = [], savings = '20', viewAll, onViewAll, showComboIcon = true, rowCards = false, dataId = 'bundle-sheet' }) {
  ...
  const footer = (
    <div data-id={did('footer')} className="flex flex-col items-center gap-3 p-3">
      <Squircle
        as="button"
        type="button"
        cornerRadius={12}
      ...
      {open && (
        <motion.div key={dataId} data-id={dataId} className="fixed inset-0 z-[60] flex justify-center">
          ...
          <div className="relative w-full max-w-md">
            ...
            >
              {rowCards && (
                <div data-id={did('handle')} className="mb-2 flex justify-center">
